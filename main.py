...
######## else returns the original player_id
...
######## Return Type:
######## None
######## prints the roster's players with their positions
...
######## else returns the original owner_id
...
def main():
    ...
    # Test player lookup
    #print(GetPlayerName("3294", players))
    ...
    for roster in rosters:
        ...
        #for playerID in roster["players"]:
            #print(GetPlayerPosition(playerID, players) + " " + GetPlayerName(playerID, players))
